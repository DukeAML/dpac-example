            ...
            [
                html.Div(
                    [
                        ...
                        html.Img(
                            src=app.get_asset_url("dpac.png"),
                            id="plotly-image2",
                            style={
                                "height": "60px",
                                "width": "auto",
        ...
        html.Div(
            [
                html.Div(
                    [
                        html.P(
                            "Filter by event date (or select range in histogram):",
                        ...
                        html.P("Filter by Event Type", className="control_label"),
                        dcc.RadioItems(
                ...
                html.Div(
                    [
                        html.Div(
                            [
                                html.Div(
                                    [html.H6(id="well_text"), html.P("No. of Ticket Sales")],
                                    id="wells",
                                    className="mini_container",
                                ),
                                html.Div(
                                    [html.H6(id="gasText"), html.P("No. of Concession Sales")],
                                    id="gas",
                                    className="mini_container",
                                ),
                                html.Div(
                                    [html.H6(id="oilText"), html.P("$ from Concession Sales")],
                                    id="oil",
                                    className="mini_container",
                                ),
                                html.Div(
                                    [html.H6(id="waterText"), html.P("$ from Ticket Sales")],
                                    id="water",
                                    className="mini_container",
                                ),
                            ],
